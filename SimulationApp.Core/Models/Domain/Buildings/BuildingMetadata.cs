namespace SimulationApp.Core.Models.Domain.Buildings {
    public record BuildingMetadata {
        ...
        public string IconEmpty { get; init; } = string.Empty;
        public string IconLow { get; init; } = string.Empty;
        public string IconMedium { get; init; } = string.Empty;
        public string IconFull { get; init; } = string.Empty;
    }
}
